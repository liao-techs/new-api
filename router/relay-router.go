...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.RawRelayArchive())
	...
	relayV1Router.Use(middleware.RawRelayArchive())
	...
	relaySunoRouter.Use(middleware.RawRelayArchive())
	...
	relayGeminiRouter.Use(middleware.RawRelayArchive())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.RawRelayArchive())
