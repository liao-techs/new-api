...
describe('HtmlContent isolated iframe sandbox', () => {
  it('allows Channel Pulse to refresh without granting same-origin access', () => {
  ...
  it('keeps script execution blocked for other iframe origins', () => {
    const sandbox = getIsolatedIframeSandbox(
  ...
  it('does not trust an origin prefix lookalike', () => {
    const sandbox = getIsolatedIframeSandbox(
